...
class __Mustache_653b385ebc455e4d597a98e9a1a15dcc extends Mustache_Template
{
...
';
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '    <button type="button" class="btn btn-secondary btn-small" id="toggle-timer" aria-controls="quiz-timer" aria-describedby="quiz-timer">
';
        $buffer .= $indent . '        ';
        $value = $context->find('str');
